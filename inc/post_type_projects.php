...
function project_post_type() {
	...
	$labels = array(
		'name'                  => _x( 'Projects', 'Post Type General Name', 'finepoint' ),
		'singular_name'         => _x( 'Project', 'Post Type Singular Name', 'finepoint' ),
		'menu_name'             => __( 'Projects', 'finepoint' ),
		'name_admin_bar'        => __( 'Projects', 'finepoint' ),
		'archives'              => __( 'Item Archives', 'finepoint' ),
		'attributes'            => __( 'Item Attributes', 'finepoint' ),
		'parent_item_colon'     => __( 'Parent Item:', 'finepoint' ),
		'all_items'             => __( 'Projects', 'finepoint' ),
...
function custom_taxonomy() {
	...
	$labels = array(
		'name'                       => _x( 'Project Categories', 'Taxonomy General Name', 'finepoint' ),
		'singular_name'              => _x( 'Project Category', 'Taxonomy Singular Name', 'finepoint' ),
		'menu_name'                  => __( 'Project Category', 'finepoint' ),
