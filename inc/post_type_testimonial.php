...
function testimonial_post_type() {
	...
	$labels = array(
		'name'                  => _x( 'Testimonials', 'Post Type General Name', 'finepoint' ),
		'singular_name'         => _x( 'Testimonial', 'Post Type Singular Name', 'finepoint' ),
		'menu_name'             => __( 'Testimonials', 'finepoint' ),
		'name_admin_bar'        => __( 'Testimonials', 'finepoint' ),
		'archives'              => __( 'Item Archives', 'finepoint' ),
		'attributes'            => __( 'Item Attributes', 'finepoint' ),
		'parent_item_colon'     => __( 'Parent Item:', 'finepoint' ),
		'all_items'             => __( 'Testimonials', 'finepoint' ),
	...
	$args = array(
		'label'                 => __( 'Testimonials', 'finepoint' ),
